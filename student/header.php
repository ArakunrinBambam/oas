<header>
	<div class="navbar navbar-default" role="navigator">
        	...
        	<ul class="nav navbar-nav">
               ...
               <button type="button" class="btn btn-primary navbar-btn navbar-right" style="margin-right:0px;">Signed as <i class="fa fa-user"></i> <?php echo $_SESSION['sname']; ?> </button>
			   <ul class="dropdown-menu pull-right nc" role="menu">
			      <li><a href="#" style="color:#333;">Update Profile</a></li>
			      <li class="divider"></li>
